...
import myEpicGame from './utils/GameNFT.json';
  ...
  if (!currentAccount) {
    return (
      <div className="connect-wallet-container">
        <img
          src="https://media.giphy.com/media/xT39CTrFW4nHLdBPpu/giphy.gif"
          alt="universe gif"
        />
        <button
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <p className="header gradient-text">⚔️ Legends ⚔️</p>
          <p className="sub-text">Destroy Dormamu, save the metaverse.</p>
